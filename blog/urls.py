...
from . import views
from .views import IndexView, LikePostView, PostView, LikeCommentView, CreateCommentView, SearchView, CommentView, PostCreateView
...
urlpatterns = [
    ...
    path('posts/post/delete/', PostView.as_view(), name='blog-post-delete'),
